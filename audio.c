...
#define AUDIO_FREQUENCY 45000//46000
 ...
 *
 */
static inline void playAudio(char * filename, Audio * audio, uint8_t loop, int volume);
...
Audio * createAudio(char * filename, uint8_t loop, int volume)
{
